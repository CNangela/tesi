...
\newglossaryentry{githubactions} {
    ...
    text=GitHub Actions,
    sort=githubactions,
    description={\emph{GitHub Actions} è il sistema di automazione integrato in GitHub. Permette di definire \emph{workflow} — sequenze di operazioni automatiche descritte in file YAML — che vengono eseguiti al verificarsi di eventi sul repository, come un push o una pull request. È comunemente utilizzato per automatizzare il processo di build, esecuzione dei test e deploy dell'applicazione.}
}
...
\newglossaryentry{amazons3}{
    ...
    text={Amazon S3},
    sort={amazons3},
    description={Acronimo di \emph{Simple Storage Service}, è un servizio di archiviazione a oggetti offerto da \emph{Amazon Web Services} che garantisce scalabilità, disponibilità, sicurezza e prestazioni. I dati vengono organizzati in contenitori chiamati \emph{bucket} e sono accessibili tramite interfaccia web.}
}
...
\newglossaryentry{ocr}{
    ...
    text={OCR},
    sort={ocr},
    description={Acronimo di \emph{Optical Character Recognition}, indica la tecnologia che converte immagini contenenti testo in testo codificato in formato leggibile da un computer. Viene tipicamente impiegata per digitalizzare documenti scansionati o PDF privi di testo selezionabile}
}