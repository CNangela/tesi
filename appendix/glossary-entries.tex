...
\newglossaryentry{mammoth} {
    ...
    text=Mammoth,
    sort=mammoth,
    description={\emph{Mammoth} è una libreria per Node.js che converte documenti in formato DOCX in HTML, mantenendo la struttura semantica del documento originale come titoli, paragrafi, elenchi e tabelle}
}
